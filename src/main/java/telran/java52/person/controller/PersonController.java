...
public class PersonController {
	...
	@GetMapping("/person/children")
	public Child[] findAllChildren() {
		return personService.findAllChildren();
	}

	@GetMapping("/person/salary/{minSalary}/{maxSalary}")
	public Employee[] findEmployeesBySalary(Integer minSalary, Integer maxSalary) {
